...
**2nd Version: https://leetcode.com/problems/letter-combinations-of-a-phone-number/discuss/360946/C%2B%2B%3A-faster-100-in-time-and-100-in-memory**  
```c++
class Solution {
public:
    vector<char> buff;
    const map<char, string> mp = {{'2', "abc"},
                                  {'3', "def"},
                                  {'4', "ghi"},
                                  {'5', "jkl"},
                                  {'6', "mno"},
